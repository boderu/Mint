/* mfptoken.h  for MinForth Plus (derived from mftoken.c)
  --------------------------------------------------------------------------
  ...
  Modifications are marked with a time stamp in the form MM-yyddmm.
*/
...
#if _OSTYPE == 2  /* API extension for Windows PCs */
...
#define PRIMNUMBER      115  /* total number of execution tokens */
...
#define xt_FAR          110
#define xtUSLEEP        111
#define xtSYSCALL       112
#define xtDLOPEN        113
#define xtDLCLOSE       114
#define xtDLSYM         115
#define xtCALL          116
#define xtIO2CB         117
#define xtATX           118
#define xtGETPID        119
/* #define xtREADLINK      120  */
#define xtAPPDIR        120   /* MM-190402  OSX */
#define xtCELL          121   /* MM-32/64 */
#define xtLONG_MIN      122


#define PRIMNUMBER      123  /* total number of execution tokens */
