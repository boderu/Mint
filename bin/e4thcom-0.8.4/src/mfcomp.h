...
#if defined(__amd64__)    /* MATH_64 = 1/0 for 32/64 Bit        MM-32/64  */
#define MATH_64 	0   
#else
#define MATH_64 	1  
#endif

/* #define DAddr       unsigned long long       moved to mfp.c  MM-32/64  */

#define CellSize    (sizeof(long))    /* MM-32/64-170221  */
